...
# Save descriptive statistics to CSV
write.csv(desc_stats, "C:/Users/hta031/Github/FEDProtein/results/Interaction_time_stats/MELT/descriptive_stats_interaction_times.csv", row.names = FALSE)
...
# Save ANOVA results to CSV
write.csv(anova_table, "C:/Users/hta031/Github/FEDProtein/results/Interaction_time_stats/MELT/anova_results_interaction_times.csv", row.names = FALSE)
...
# Save Tukey HSD results to CSV with group labels
write.csv(tukey_table, "C:/Users/hta031/Github/FEDProtein/results/Interaction_time_stats/MELT/tukey_results_interaction_times_with_groups.csv", row.names = FALSE)
# Step 4: Holm post-hoc test
# Perform pairwise t-tests with Holm correction
...
holm_table <- as.data.frame(holm_test$p.value)
holm_table$Comparison <- rownames(holm_table)
write.csv(holm_table, "C:/Users/hta031/Github/FEDProtein/results/Interaction_time_stats/MELT/holm_results_interaction_times_with_groups.csv", row.names = FALSE)

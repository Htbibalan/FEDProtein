...
# Load the data
data <- read.csv("C:/Users/hta031/Github/FEDProtein/results/FIVE/SCATTER_PLOTS/BODYWEIGHT/AV_BODYWEIGHT_PER_PHASE.csv")
...
# Save descriptive statistics to CSV
write.csv(desc_stats, "C:/Users/hta031/Github/FEDProtein/results/FIVE/SCATTER_PLOTS/BODYWEIGHT/descriptive_TOTAL_PHASE.csv", row.names = FALSE)
...
# Save ANOVA results to CSV
write.csv(anova_table, "C:/Users/hta031/Github/FEDProtein/results/FIVE/SCATTER_PLOTS/BODYWEIGHT/anova_TOTAL_PHASE.csv", row.names = FALSE)
...
# Save Tukey HSD results to CSV with group labels
write.csv(tukey_table, "C:/Users/hta031/Github/FEDProtein/results/FIVE/SCATTER_PLOTS/BODYWEIGHT/tukey_TOTAL_PHASE.csv", row.names = FALSE)
...
holm_table <- as.data.frame(holm_test$p.value)
holm_table$Comparison <- rownames(holm_table)
write.csv(holm_table, "C:/Users/hta031/Github/FEDProtein/results/FIVE/SCATTER_PLOTS/BODYWEIGHT/holm_TOTAL_PHASE.csv", row.names = FALSE)
...
############################################################################################################
############################################################################################################
################################### DELTA DELTA DELTA Body_weight_per_phase##########################################################
#############################################################################################################
...
# Load the data
data <- read.csv("C:/Users/hta031/Github/FEDProtein/results/FIVE/SCATTER_PLOTS/BODYWEIGHT/Delta_per_phase/DELTA_BODYWEIGHT_PER_PHASE.csv")
...
# Save descriptive statistics to CSV
write.csv(desc_stats, "C:/Users/hta031/Github/FEDProtein/results/FIVE/SCATTER_PLOTS/BODYWEIGHT/Delta_per_phase/descriptive_TOTAL_PHASE.csv", row.names = FALSE)
...
# Save ANOVA results to CSV
write.csv(anova_table, "C:/Users/hta031/Github/FEDProtein/results/FIVE/SCATTER_PLOTS/BODYWEIGHT/Delta_per_phase/anova_TOTAL_PHASE.csv", row.names = FALSE)
...
# Save Tukey HSD results to CSV with group labels
write.csv(tukey_table, "C:/Users/hta031/Github/FEDProtein/results/FIVE/SCATTER_PLOTS/BODYWEIGHT/Delta_per_phase/tukey_TOTAL_PHASE.csv", row.names = FALSE)
...
holm_table <- as.data.frame(holm_test$p.value)
holm_table$Comparison <- rownames(holm_table)
write.csv(holm_table, "C:/Users/hta031/Github/FEDProtein/results/FIVE/SCATTER_PLOTS/BODYWEIGHT/Delta_per_phase/holm_TOTAL_PHASE.csv", row.names = FALSE)
